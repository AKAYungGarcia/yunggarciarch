const storageKey = "akayunggarcia-standalone-v33";
...
const designVersion = "cybergoth-techmark-v1";
...
const initialData = {
  ...
  theme: {
    ...
    text: "#f8f8fa",
    muted: "#8fbf91",
    serif: "'Zen Dots', 'Orbitron', 'Black Ops One', 'Audiowide', 'Oxanium', 'Rajdhani', sans-serif",
