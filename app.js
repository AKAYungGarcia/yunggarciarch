const storageKey = "akayunggarcia-standalone-v25";
...
const designVersion = "final-product-v2";
...
const initialData = {
  ...
  theme: {
    ...
    text: "#eef8ed",
    muted: "#93b79e",
    serif: "'Bahnschrift SemiCondensed', 'Arial Narrow', 'Roboto Condensed', Impact, sans-serif",
